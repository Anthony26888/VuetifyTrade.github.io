<template>
  <v-container class="fill-height">
    <v-column class="mx-auto text-center">
      <v-img
        height="300"
        class="mx-auto"
        src="@/assets/img/logo-eagle.png"
        :width="300"
      />      
      <h3 class="mt-3">{{ title }}</h3>
      <span class="text-muted mx-auto">{{ description }}</span
      ><br />
      <router-link to="/LogIn">
        <v-btn color="primary" :width="200" class="mt-3" to="/LogIn"
          >Get Started</v-btn
        >
      </router-link>
    </v-column>
